...
#### Map
Module [`es6.map`](https://github.com/zloirock/core-js/blob/v1.2.6/modules/es6.map.service.js). About iterators from this module [here](#ecmascript-6-iterators).
```javascript
...
```
#### WeakMap
Module [`es6.weak-map`](https://github.com/zloirock/core-js/blob/v1.2.6/modules/es6.weak-map.service.js).
```javascript
...
```
Modules [`es6.map`](https://github.com/zloirock/core-js/blob/v1.2.6/modules/es6.map.service.js) and [`es6.set`](https://github.com/zloirock/core-js/blob/v1.2.6/modules/es6.set.js):
```javascript
Map
  #values() -> iterator
  #keys() -> iterator
